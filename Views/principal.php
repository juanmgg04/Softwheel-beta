...
use UsersController as GlobalUsersController;
...
if($usuario==null || $usuario==''){
  ...
  echo '<script language="javascript">alert("Debes iniciar sesión.");window.location.href="../Controllers/UsersController.php?action=login"</script>';
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-outline card-dark">
                            <div class="card-header">
                                <h3 class="card-title">Mapa actual del parqueadero</h3>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="btn_registrar_ticket<?php echo $id_map;?>">Registrar auto</button>
                                                                    <script>
                                                                        $('#btn_registrar_ticket<?php echo $id_map;?>').click(function () {
                                                                           ...
                                                                           var user_session = "<?php echo $_SESSION['nombre_apellidos']; ?>";
                                                                           ...
                                                                           if(placa == ""){
                                                                              alert('Debe de llenar el campo Placa');
                                                                               ...
                                                                               alert('Debe de llenar el campo identificación');
                                            ...
                                            <div class="col">
                                                <center>
                                                    ...
                                                    <button class="btn btn-info" id="btn_ocupado<?php echo $id_map;?>" data-toggle="modal"
                                                        ...
                                                        <img src="<?php echo $URL;?>/Views/public/imagenes/auto1.png" width="60px" alt="">
                                                    </button>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="tickets/controller_cancelar_ticket.php?id=<?php echo $id_ticket;?>&&cuviculo=<?php echo $cuviculo;?>" class="btn btn-danger">Cancelar ingreso</a>
                                                                    <button type="button" class="btn btn-success" id="btn_facturar<?php echo $id_map;?>">Salida de auto</button>
                                                                    <?php
                                                                    ...
                                                                    <script>
                                                                        $('#btn_facturar<?php echo $id_map;?>').click(function () {
                                                                            ...
                                                                            var id_ticket = "<?php echo $id_ticket; ?>";

                                                                            var url_4 = 'facturacion/controller_registrar_factura.php';
                                                                            $.get(url_4,{id_informacion:id_informacion,nro_factura:nro_factura,id_cliente:id_cliente,fecha_ingreso:fecha_ingreso,hora_ingreso:hora_ingreso,cuviculo:cuviculo,user_sesion:user_sesion,id_ticket:id_ticket},function (datos) {
